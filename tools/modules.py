...
class ModuleWorld:
    ...
    def _spawn_hero(self):
        ...
        spawn_point = carla.Transform(location=carla.Location(x=x, y=y, z=z+4),
...
class TrafficManager:
    ...
    def spawn_one_actor(self, s, lane, targetSpeed, velocity_curve):
        ...
        transform = carla.Transform(location=carla.Location(x=x, y=y, z=z + 4),
                                    rotation=carla.Rotation(pitch=0.0, yaw=math.degrees(yaw), roll=0.0))
    ...
    def reset(self, ego_s, ego_d):
        ...
        for idx in rnd_indices:
            ...
            lane = idx - col * 4 - 1  # lane number [-1, 2]，此处为0
            s = ego_s + col * 10 - 20 + 50
...
class CruiseControl:
    ...
    def tick(self,action,adversarial):
        ...
        if adversarial == 1:
            ...
            # control.brake = action[1][1]
            # control.steer = action[1][2]
            control = action[1]
            """用于SAC决策两个连续动作的动作空间"""
