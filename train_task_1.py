    ...
    while True:
        ...
        while not done:
            ...
            if done:
                ...
                print("episode:{} mean episode score:{} episode time steps:{}".format(i_episode, mean_episode_score, info[1]))
...
def main():
    ...
    owl_parser.add_argument('--tag', type=str, default='sac_ewc_car_following_env_1', help='unique str to tag tb.')
    owl_parser.add_argument('--logdir', dest='logdir', default='runs_single_task_car_following_env_1', type=str,
    ...
    if owl_args.owl:
        ...
        agent = SACAgent(state_dim=3, action_dim=1, max_action=3.0, min_action=-3.0, num_tasks=1, hidden_size=256, actor_lr=0.0003,
                         critic_lr=0.0003, q_ewc_reg=0.0, gamma=0.99, q_lr=3e-4, batch_size=256, tau=0.005, adaptive_alpha=True, pool_size=100000)
