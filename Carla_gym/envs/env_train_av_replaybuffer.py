...
class CarlagymEnv1(gym.Env):
    ...
    def step(self, action):
        ...
        # # 总奖励
        reward = float(reward_cl + reward_sp + reward_distance + reward_overtake + reward_comfort + reward_not_go)# + reward_alive_distance)
        ...
        return self.obs_nearest_five_bv(), reward, done, info
