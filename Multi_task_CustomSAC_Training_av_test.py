...
def make_env(env_id):
    ...
    if env_id == 1:
        carla_gym_parser.add_argument('--cfg_file', type=str, default='./tools/cfgs/config.yaml',
                                      help='specify the config for training')
        carla_gym_parser.add_argument('-p', '--carla_port', metavar='P', default=15100, type=int,
                                      help='TCP port to listen to (default: 5100)')
        carla_gym_parser.add_argument('--tm_port', default=26100, type=int,
        ...
        carla_gym_parser.add_argument('--cfg_file', type=str, default='./tools/cfgs/config.yaml',
                                      help='specify the config for training')
        carla_gym_parser.add_argument('-p', '--carla_port', metavar='P', default=15400, type=int,
                                      help='TCP port to listen to (default: 5400)')
        carla_gym_parser.add_argument('--tm_port', default=26400, type=int,
        ...
        carla_gym_parser.add_argument('--cfg_file', type=str, default='./tools/cfgs/config.yaml',
                                      help='specify the config for training')
        carla_gym_parser.add_argument('-p', '--carla_port', metavar='P', default=15110, type=int,
                                      help='TCP port to listen to (default: 5400)')
        carla_gym_parser.add_argument('--tm_port', default=26110, type=int,
                                      help='Traffic Manager TCP port to listen to (default: 16400)')
...
if __name__ == '__main__':
    ...
    if train_npc == 1:
        ...
        checkpoint_callback = CheckpointCallback(save_freq=250000,
                                                 save_path='./Training_Results/0613_final/AV_Model_SAC', verbose=1)
        ...
        model.learn(total_timesteps=9000000, log_interval=1, callback=callback_list, tb_log_name="train_0613_actor10_critic_e6",
                    reset_num_timesteps=False)
        model.save("./Training_Results/0613_final/AV_Model_SAC_final")
